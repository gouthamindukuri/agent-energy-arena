    ...
    def reset(
        ...
        *,
        ...
        self.state = WorldState(
            ...
            grid_transfer_capacity_kw=self.config.grid_transfer_capacity_kw,
            grid_external_export_capacity_kw=self.config.grid_external_export_capacity_kw,
            transmission_line_capacity_kw=self.config.transmission_line_capacity_kw,
            curtailment_compensation_per_kwh=self.config.curtailment_compensation_per_kwh,
            replacement_energy_cost_per_kwh=self.config.replacement_energy_cost_per_kwh,
    ...
    def state_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "config": {
                ...
                "grid_transfer_capacity_kw": c.grid_transfer_capacity_kw,
                "grid_external_export_capacity_kw": c.grid_external_export_capacity_kw,
                "transmission_line_capacity_kw": c.transmission_line_capacity_kw,
                "curtailment_compensation_per_kwh": c.curtailment_compensation_per_kwh,
                "replacement_energy_cost_per_kwh": c.replacement_energy_cost_per_kwh,
                "session": self.session,
                "active_game_days": (
            ...
            "grid_constraints": {
                "grid_transfer_capacity_kw": s.grid_transfer_capacity_kw,
                "grid_external_export_capacity_kw": s.grid_external_export_capacity_kw,
                "transmission_line_capacity_kw": s.transmission_line_capacity_kw,
                "curtailment_compensation_per_kwh": s.curtailment_compensation_per_kwh,
                "replacement_energy_cost_per_kwh": s.replacement_energy_cost_per_kwh,
            },
            ...
            "cumulative_exported_kwh": s.cumulative_exported_kwh,
            "cumulative_curtailed_renewable_kwh": s.cumulative_curtailed_renewable_kwh,
            "cumulative_replacement_energy_kwh": s.cumulative_replacement_energy_kwh,
